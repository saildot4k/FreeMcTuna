...
EE_BIN_PACKED = FMCT-INSTALLER.ELF
...
EE_OBJS += restartdel_icn.o restarticon_sys.o restartlist_icn.o restart_elf.o powerdel_icn.o powericon_sys.o powerlist_icn.o poweroff_elf.o apps_icn.o appsdel_icn.o appsicon_sys.o  \
	esr_elf.o boot2_elf.o boot_elf.o icon_sys.o copy_icn.o del_icn.o boot_icn.o config_ini.o appinfo_pbt.o gh2manger_elf.o whatisbootx_txt.o osdmenu_elf.o OpenTuna_sys.o OpenTuna_SLIMS.o OpenTuna_FAT-170.o \
...
EE_SRC = restartdel_icn.s restarticon_sys.s restartlist_icn.s restart_elf.s powerdel_icn.s powericon_sys.s powerlist_icn.s poweroff_elf.s \
	...
	boot_icn.s config_ini.s appinfo_pbt.s gh2manger_elf.s whatisbootx_txt.s osdmenu_elf.s OpenTuna_sys.s OpenTuna_SLIMS.s OpenTuna_FAT-170.s OpenTuna_FAT-110-120-150-160.s \
...
gh2manger_elf.s:
	bin2s INSTALL/BOOT/GH2MANGER.ELF gh2manger_elf.s gh2manger_elf
